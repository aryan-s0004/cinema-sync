...
export const authApi = {
  ...
  requestLoginOtp: async (payload) => (await api.post("/auth/login/otp/request", payload)).data.data,
  googleLogin: async (payload) => (await api.post("/auth/google", payload)).data.data,
